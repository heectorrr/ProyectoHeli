document.addEventListener('DOMContentLoaded', () => {
    ...
    function jump() {
        if (!isJumping) {
            ...
            let jumpHeight = 300; // Adjusted jump height (you can tweak this value as needed)
            let jumpIncrement = 15; // Adjusted jump increment (you can tweak this value as needed)
            let jumpInterval = setInterval(() => {
                if (jumpHeight > 0) {
                    ...
                    let fallInterval = setInterval(() => {
                        if (playerBottom > 300) {
                            playerBottom -= 20; // Adjusted fall speed
                            player.style.bottom = playerBottom + 'px';
                        } else {
